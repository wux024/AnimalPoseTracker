...
################################################################################
## Form generated from reading UI file 'trackerFpKaOT.ui'
##
...
class Ui_Tracker(object):
    def setupUi(self, Tracker):
        ...
        self.ShowToolsGroup = QGroupBox(Tracker)
        ...
        self.verticalLayout.addLayout(self.ConfigureLayout)

        self.DisplayGroup = QGroupBox(Tracker)
    ...
    def retranslateUi(self, Tracker):
        Tracker.setWindowTitle(QCoreApplication.translate("Tracker", u"AnimalPoseInference", None))
        self.BaseToolsGroup.setTitle("")
        self.SelectConfigure.setText(QCoreApplication.translate("Tracker", u"Select Configure", None))
        self.SelectWeights.setText(QCoreApplication.translate("Tracker", u"Select Weights", None))
        self.CameraORVideos.setText(QCoreApplication.translate("Tracker", u"Use Video", None))
        self.CameraVideosSelection.setItemText(0, QCoreApplication.translate("Tracker", u"...", None))
        self.CameraVideosSelection.setItemText(1, QCoreApplication.translate("Tracker", u"Select video file...", None))

        self.CheckCameraVideosConnect.setText(QCoreApplication.translate("Tracker", u"Preview Video", None))
        self.WidthLabel.setText(QCoreApplication.translate("Tracker", u"Width", None))
        self.HeightLabel.setText(QCoreApplication.translate("Tracker", u"Height", None))
        self.FPSLabel.setText(QCoreApplication.translate("Tracker", u"FPS", None))
        self.ModelBitsLabel.setText(QCoreApplication.translate("Tracker", u"Model Bits", None))
        self.ModelBits.setItemText(0, QCoreApplication.translate("Tracker", u"FP32", None))
        self.ModelBits.setItemText(1, QCoreApplication.translate("Tracker", u"FP16", None))
        self.ModelBits.setItemText(2, QCoreApplication.translate("Tracker", u"INT8", None))

        self.EngineLabel.setText(QCoreApplication.translate("Tracker", u"Inference Engine", None))
        self.EngineSelection.setItemText(0, QCoreApplication.translate("Tracker", u"OpenCV", None))
        self.EngineSelection.setItemText(1, QCoreApplication.translate("Tracker", u"ONNX", None))
        self.EngineSelection.setItemText(2, QCoreApplication.translate("Tracker", u"OpenVINO", None))
        self.EngineSelection.setItemText(3, QCoreApplication.translate("Tracker", u"TensorRT", None))
        self.EngineSelection.setItemText(4, QCoreApplication.translate("Tracker", u"CoreML", None))
        self.EngineSelection.setItemText(5, QCoreApplication.translate("Tracker", u"CANN", None))

        self.DeviceLabel.setText(QCoreApplication.translate("Tracker", u"Inference Device", None))
        self.DeviceSelection.setItemText(0, QCoreApplication.translate("Tracker", u"Intel CPU", None))
        self.DeviceSelection.setItemText(1, QCoreApplication.translate("Tracker", u"Intel GPU", None))
        self.DeviceSelection.setItemText(2, QCoreApplication.translate("Tracker", u"Intel NPU", None))
        self.DeviceSelection.setItemText(3, QCoreApplication.translate("Tracker", u"NVIDIA GPU", None))
        self.DeviceSelection.setItemText(4, QCoreApplication.translate("Tracker", u"AMD CPU", None))
        self.DeviceSelection.setItemText(5, QCoreApplication.translate("Tracker", u"AMD GPU", None))
        self.DeviceSelection.setItemText(6, QCoreApplication.translate("Tracker", u"ARM CPU", None))
        self.DeviceSelection.setItemText(7, QCoreApplication.translate("Tracker", u"Ascend NPU", None))

        self.TrackerLabel.setText(QCoreApplication.translate("Tracker", u"Tracker Engine", None))
        self.TrackerSelection.setItemText(0, QCoreApplication.translate("Tracker", u"SORT", None))
        self.TrackerSelection.setItemText(1, QCoreApplication.translate("Tracker", u"BoT-SORT", None))
        self.TrackerSelection.setItemText(2, QCoreApplication.translate("Tracker", u"ByteTrack", None))

        self.Start.setText(QCoreApplication.translate("Tracker", u"Start", None))
        self.End.setText(QCoreApplication.translate("Tracker", u"End", None))
        self.PrintInformation.setText(QCoreApplication.translate("Tracker", u"Some print information", None))
        self.ShowToolsGroup.setTitle("")
        self.Save.setText(QCoreApplication.translate("Tracker", u"Save", None))
        self.IoULabel.setText(QCoreApplication.translate("Tracker", u"IoU", None))
        self.ConfLabel.setText(QCoreApplication.translate("Tracker", u"Conf", None))
        self.Show.setText(QCoreApplication.translate("Tracker", u"Show", None))
        self.Backgroud.setText(QCoreApplication.translate("Tracker", u"Original", None))
        self.ShowClasses.setText(QCoreApplication.translate("Tracker", u"Show Classes", None))
        self.Classes.setText("")
        self.ShowKeypoints.setText(QCoreApplication.translate("Tracker", u"Show Keypoints", None))
        self.ShowSkeletons.setText(QCoreApplication.translate("Tracker", u"Show Skeletons", None))
        self.ShowBBox.setText(QCoreApplication.translate("Tracker", u"Show BBox", None))
